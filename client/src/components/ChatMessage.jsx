              ...
              <ReactMarkdown
                ...
                components={{
                  code({ node, inline, className, children, ...props }) {
                    ...
                    const isHtmlOrWeb = lang === 'html' || rawCode.includes('<!DOCTYPE') || rawCode.includes('<html') || (rawCode.includes('<div') && rawCode.includes('class'));
                          ...
                          <div className="flex items-center gap-2">
                            {isHtmlOrWeb && (
                              <button
                                ...
                                className="px-2 py-0.5 rounded-md bg-gradient-to-r from-cyan-500 to-purple-600 text-white hover:from-cyan-400 hover:to-purple-500 transition-all text-[10px] font-medium flex items-center gap-1 shadow-sm"
                              >
