...
export default function Sidebar({
  ...
  return (
    <>
      ...
      {/* Sidebar Container */}
      <aside
        className={`fixed top-0 left-0 bottom-0 z-50 w-72 lg:static glass-panel border-r border-white/10 flex flex-col transition-transform duration-300 ease-in-out ${
