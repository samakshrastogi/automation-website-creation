    ...
    <div className="fixed inset-0 z-[99999] flex items-center justify-center p-2 sm:p-4 md:p-6 bg-black/90 backdrop-blur-2xl overflow-hidden">
      ...
      >
        ...
        <div className="px-4 py-3 bg-slate-900/90 border-b border-white/10 flex items-center justify-between gap-2 md:gap-4 shrink-0">
          ...
          {/* Right: Actions & Download ZIP Exporter */}
          <div className="flex items-center gap-1.5 shrink-0">
            ...
            <button
              ...
              className="px-3 py-1.5 rounded-xl text-xs font-bold text-white bg-gradient-to-r from-purple-600 to-cyan-500 hover:from-purple-500 hover:to-cyan-400 shadow-md shadow-purple-500/20 flex items-center gap-1.5 transition-all active:scale-95 ml-1"
